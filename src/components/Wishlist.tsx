...
import { ArrowLeft, Heart, ShoppingCart, Home, Grid2X2, MessageCircle, User } from 'lucide-react';
...
export default function Wishlist({ onBack, onNavigate }: WishlistProps) {
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <header className="bg-white/90 backdrop-blur-md sticky top-0 z-50 h-16 flex items-center px-5 max-w-screen-xl mx-auto w-full border-b border-neutral-100">
        ...
        <span className="ml-4 text-lg font-display font-bold text-primary">Your Wishlist</span>
      </header>
      ...
      <main className="max-w-screen-xl mx-auto px-5 py-20 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-on-surface-variant text-sm mt-1 max-w-[240px]">Save your favorite fresh harvests here to buy them later.</p>
        <button 
